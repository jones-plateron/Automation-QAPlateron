...
Scenario Outline: As a RMS User, I need to Validate Bill Settings Page
    ...
    And User should Click Bill Configuration and Verify the Bill Configuration Page Opens
    ...
    Given Login to the restaurant with "<mobileNumber>" and "<otp>"
    Then User should able to Click Settings Sections
    And User should Click Gratuity Configuration and Verify the Gratuity Configuration Page Opens with "Gratuity Configuration"
