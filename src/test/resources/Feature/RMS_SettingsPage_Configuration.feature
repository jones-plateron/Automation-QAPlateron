...
Feature: Settings Page Configuration
  ...
  Scenario Outline: As a RMS User, I need to Validate Bill Settings Page
    ...
    And User should Verify the Instruction "if gratuity need not be applied please enter" under Gratuity percentage option
    Then User should Verify "Gratuity will be added on bill when subtotal reaches this amount" option is present and Validate the Textboxs
    ...
    Then User should Verify "Tax to be applied on gratuity amount" option is presents and Validate the Textbox
