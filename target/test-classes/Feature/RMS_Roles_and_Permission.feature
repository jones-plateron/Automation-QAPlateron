...
Feature: Title of your feature
  ...
  Scenario Outline: As a RMS user, I need to Create new jobs and set permission for the New Role
    ...
    Then User should able enter the New "<Job Name>" and Click save button
    ...
    Then User should able to see the edit icon and click to edit "<Edit Name>" the Role Name

    Examples: 
      | mobileNumber | otp    | Job Name with Special character | Job Name | Edit Name |
      |   7777777723 | 666666 | Ac@;'.';'?/'                    | Baker    | Bakers    |
